...
Repository: https://github.com/RanaPriyansh/thielon-agent-hub.git
Canonical local path: /root/git-repos/agent-hub
Default branch: main
...
3. Run the local setup path for agent-hub and write exact commands back into README if they are missing or stale.
